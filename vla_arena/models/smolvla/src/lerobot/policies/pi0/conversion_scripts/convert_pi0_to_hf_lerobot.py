...
python -m lerobot.policies.pi0.conversion_scripts.convert_pi0_to_hf_lerobot \
    --checkpoint_dir /path/to/openpi/checkpoints/pi0_base/params \
    --output_path /path/to/openpi/checkpoints/pi0_base_pytorch
```

```python
python -m lerobot.policies.pi0.conversion_scripts.convert_pi0_to_hf_lerobot \
    --checkpoint_dir /path/to/openpi/checkpoints/pi0_aloha_sim/params \
    --output_path /path/to/openpi/checkpoints/pi0_aloha_sim_pytorch
```
"""
