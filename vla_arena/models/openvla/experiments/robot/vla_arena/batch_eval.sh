...
# Set OPENVLA_DEFAULT_CHECKPOINT environment variable to specify a custom checkpoint path.
DEFAULT_CHECKPOINT="${OPENVLA_DEFAULT_CHECKPOINT:-/path/to/your/openvla-checkpoint}"
